...
import org.jkiss.dbeaver.ext.alti.AltibaseMessages;
...
public class AltibaseMetaModel extends GenericMetaModel
{
    ...
    public String getViewDDL(DBRProgressMonitor monitor, GenericView sourceObject, Map<String, Object> options) throws DBException {
    	...
    	if (DBMS_METADATA) {
    		ddl = getDDLFromDbmsMetadata(monitor, sourceObject, sourceObject.getSchema().getName(), sourceObject.getTableType().replaceAll(" ", "_"));
    	}
