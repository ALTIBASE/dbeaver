 ...
 * Altibase sequence
 */
public class AltibaseO2AQueue extends AltibaseO2ASchemaObject {

    private static final Log log = Log.getLog(AltibaseO2AQueue.class);
    ...
    public AltibaseO2AQueue(AltibaseO2ASchema schema, String name) {
        super(schema, name, false);
    }

    public AltibaseO2AQueue(AltibaseO2ASchema schema, ResultSet dbResult) {
    ...
    public AltibaseO2ATableBase getQueueTable(DBRProgressMonitor monitor) throws DBException {
