 ...
 */
public class AltibaseO2ATableConstraint extends AltibaseO2ATableConstraintBase {

    private static final Log log = Log.getLog(AltibaseO2ATableConstraint.class);

    private String searchCondition;

    public AltibaseO2ATableConstraint(AltibaseO2ATableBase oracleTable, String name, DBSEntityConstraintType constraintType, String searchCondition, AltibaseO2AObjectStatus status)
    {
        super(oracleTable, name, constraintType, status, false);
        this.searchCondition = searchCondition;
    }

    public AltibaseO2ATableConstraint(AltibaseO2ATableBase table, ResultSet dbResult)
    {
        super(
            table,
