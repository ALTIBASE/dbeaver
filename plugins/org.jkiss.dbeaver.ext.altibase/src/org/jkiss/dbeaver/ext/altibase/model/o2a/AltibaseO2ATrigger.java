 ...
 * AltibaseTrigger
 */
public abstract class AltibaseO2ATrigger<PARENT extends DBSObject> extends AltibaseO2AObject<PARENT> implements DBSTrigger, DBPQualifiedObject, AltibaseSourceObject
{
    ...
    public AltibaseO2ATrigger(PARENT parent, String name)
    {
        super(parent, name, false);
    }

    public AltibaseO2ATrigger(
        PARENT parent,
        ResultSet dbResult)
    {
        ...
        this.status = CommonUtils.valueOf(AltibaseO2AObjectStatus.class, JDBCUtils.safeGetStringTrimmed(dbResult, "STATUS"));
    ...
    {
        return AltibaseO2ASourceType.TRIGGER;
    }
    ...
    public String getObjectDefinitionText(DBRProgressMonitor monitor, Map<String, Object> options) throws DBException
    {
        if (sourceDeclaration == null && monitor != null) {
            sourceDeclaration = AltibaseO2AUtils.getSource(monitor, this, false, false);
        }
    ...
    {
        return status == AltibaseO2AObjectStatus.ENABLED ? DBSObjectState.NORMAL : DBSObjectState.INVALID;
    }

    @Override
    public void refreshObjectState(@NotNull DBRProgressMonitor monitor) throws DBCException
    {
        this.status = (AltibaseO2AUtils.getObjectStatus(monitor, this, AltibaseO2AObjectType.TRIGGER) ? AltibaseO2AObjectStatus.ENABLED : AltibaseO2AObjectStatus.ERROR);
    }
