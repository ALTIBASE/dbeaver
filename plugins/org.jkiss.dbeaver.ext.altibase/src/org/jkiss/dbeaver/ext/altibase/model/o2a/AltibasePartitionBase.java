 ...
 */
public abstract class AltibasePartitionBase<PARENT extends DBSObject> extends AltibaseObject<PARENT> implements DBSObjectLazy
{
    ...
    public static class PartitionInfoBase {
        ...
        public PartitionInfoBase(DBRProgressMonitor monitor, AltibaseDataSource dataSource, ResultSet dbResult) throws DBException
        {
    ...
    protected AltibasePartitionBase(PARENT parent, boolean subpartition, ResultSet dbResult)
    {
        super(
            parent,
            subpartition ?
