 ...
 */
public class AltibaseMaterializedView extends AltibaseTableBase implements AltibaseSourceObject, DBSObjectLazy<AltibaseDataSource>
{
    private static final Log log = Log.getLog(AltibaseMaterializedView.class);
    ...
    public AltibaseMaterializedView(AltibaseSchema schema, String name)
    {
        super(schema, name, false);
    }

    public AltibaseMaterializedView(
    ...
    {
        return AltibaseSourceType.MATERIALIZED_VIEW;
    }
        ...
        if (query == null || currentDDLFormat != newFormat && isPersisted()) {
            try {
                if (query == null || !isFormatInOptions) {
                    query = AltibaseUtils.getDDL(monitor, getTableTypeName(), this, currentDDLFormat, options);
                } else {
                    query = AltibaseUtils.getDDL(monitor, getTableTypeName(), this, newFormat, options);
    ...
    public void setCurrentDDLFormat(AltibaseDDLFormat currentDDLFormat) {
    ...
    public DBEPersistAction[] getCompileActions(DBRProgressMonitor monitor)
    {
        return new DBEPersistAction[] {
            new AltibaseObjectPersistAction(
                AltibaseObjectType.MATERIALIZED_VIEW,
    ...
    {
        this.valid = AltibaseUtils.getObjectStatus(monitor, this, AltibaseObjectType.MATERIALIZED_VIEW);
    }
