 ...
 * Altibase synonym
 */
public class AltibaseSynonym extends AltibaseSchemaObject implements DBSAlias {
    ...
    public AltibaseSynonym(AltibaseSchema schema, ResultSet dbResult)
    {
    ...
    {
        return AltibaseObjectType.getByType(objectTypeName);
    }
    ...
    {
        final AltibaseSchema schema = getDataSource().schemaCache.getCachedObject(objectOwner);
    ...
    public Object getObject(DBRProgressMonitor monitor) throws DBException
    {
        ...
        return AltibaseObjectType.resolveObject(
            monitor,
            getDataSource(),
            dbLink,
            objectTypeName,
    ...
    public String getFullyQualifiedName(DBPEvaluationContext context) {
        if (AltibaseConstants.USER_PUBLIC.equals(getSchema().getName())) {
