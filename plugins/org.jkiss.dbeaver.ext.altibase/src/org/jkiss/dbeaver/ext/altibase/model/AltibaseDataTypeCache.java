 ...
 */
public class AltibaseDataTypeCache extends JDBCBasicDataTypeCache<AltibaseStructContainer, AltibaseDataType>
{

    private static final boolean IGNORE_NUMERIC_TYPES = false;

    public AltibaseDataTypeCache(AltibaseStructContainer owner) {
        super(owner);
