 ...
 */
public class AltibaseTableForeignKey extends JDBCTableForeignKey<AltibaseTableBase, DBSEntityReferrer> {
    private static final Log log = Log.getLog(AltibaseTableForeignKey.class);

    private DBSForeignKeyDeferability deferability;
    private List<AltibaseTableForeignKeyColumnTable> columns;
    ...
    @Override
    public List<AltibaseTableForeignKeyColumnTable> getAttributeReferences(DBRProgressMonitor monitor) {
        return columns;
    }

    public void addColumn(AltibaseTableForeignKeyColumnTable column) {
        if (columns == null) {
    ...
    void setColumns(DBRProgressMonitor monitor, List<AltibaseTableForeignKeyColumnTable> columns) {
