 ...
 */
public class AltibaseTableManager extends SQLTableManager<AltibaseTableBase, AltibaseStructContainer> {

    private static final Class<? extends DBSObject>[] CHILD_TYPES = CommonUtils.array(
        AltibaseTableColumn.class,
        AltibaseUniqueKey.class,
        AltibaseTableForeignKey.class,
    ...
    @Override
    protected void addObjectExtraActions(DBRProgressMonitor monitor, DBCExecutionContext executionContext, List<DBEPersistAction> actions, NestedObjectCommand<AltibaseTableBase, PropertyHandler> command, Map<String, Object> options) throws DBException {
        AltibaseTableBase tableBase = command.getObject();
        ...
        if (!tableBase.isPersisted()) {
            ...
            for (AltibaseTableColumn column : CommonUtils.safeCollection(tableBase.getAttributes(monitor))) {
