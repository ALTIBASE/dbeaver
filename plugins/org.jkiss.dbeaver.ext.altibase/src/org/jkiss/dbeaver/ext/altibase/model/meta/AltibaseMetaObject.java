 ...
 */
public class AltibaseMetaObject {

    private final String type;
    private final String readQuery;
    private final Map<String, AltibaseMetaColumn> columnsMap = new HashMap<>();

    public AltibaseMetaObject(IConfigurationElement cfg)
    {
        ...
        for (IConfigurationElement columnCfg : cfg.getChildren("column")) {
            AltibaseMetaColumn column = new AltibaseMetaColumn(columnCfg);
    ...
    public AltibaseMetaColumn getColumn(String id)
    {
