...
/**
 * Altibase SQL dialect
 */
public class AltibaseO2ASQLDialect extends JDBCSQLDialect implements SQLDataTypeConverter {

    private static final Log log = Log.getLog(AltibaseO2ASQLDialect.class);
    ...
    public AltibaseO2ASQLDialect() {
        super("Altibase", "oracle");
    ...
    protected void loadDataTypesFromDatabase(JDBCDataSource dataSource) {
        ...
        addDataTypes(AltibaseO2ADataType.PREDEFINED_TYPES.keySet());
    }
    ...
    public boolean isDisableScriptEscapeProcessing() {
        return preferenceStore == null || preferenceStore.getBoolean(AltibaseO2AConstants.PREF_DISABLE_SCRIPT_ESCAPE_PROCESSING);
    }
    ...
    public String getColumnTypeModifiers(@NotNull DBPDataSource dataSource, @NotNull DBSTypedObject column, @NotNull String typeName, @NotNull DBPDataKind dataKind) {
        Integer scale;
        switch (typeName) {
            case AltibaseO2AConstants.TYPE_NUMBER:
            case AltibaseO2AConstants.TYPE_DECIMAL:
                ...
                if (precision == 0 || precision > AltibaseO2AConstants.NUMERIC_MAX_PRECISION) {
                    precision = AltibaseO2AConstants.NUMERIC_MAX_PRECISION;
                }
                if (scale != null && precision > 0) {
                    return "(" + precision + ',' + scale + ")";
                }
                break;
            case AltibaseO2AConstants.TYPE_INTERVAL_DAY_SECOND:
                ...
                if (scale < 0 || scale > 9) {
                    scale = AltibaseO2AConstants.INTERVAL_DEFAULT_SECONDS_PRECISION;
                }
                return "(" + scale + ")";
            case AltibaseO2AConstants.TYPE_NAME_BFILE:
            case AltibaseO2AConstants.TYPE_NAME_CFILE:
            case AltibaseO2AConstants.TYPE_CONTENT_POINTER:
            case AltibaseO2AConstants.TYPE_LONG:
            case AltibaseO2AConstants.TYPE_LONG_RAW:
            case AltibaseO2AConstants.TYPE_OCTET:
            case AltibaseO2AConstants.TYPE_INTERVAL_YEAR_MONTH:
    ...
    public String convertExternalDataType(@NotNull SQLDialect sourceDialect, @NotNull DBSTypedObject sourceTypedObject, @Nullable DBPDataTypeProvider targetTypeProvider) {
        ...
        switch (externalTypeName) {
            case "VARCHAR":
                ...
                localDataType = AltibaseO2AConstants.TYPE_NAME_VARCHAR;
            ...
            case "XML":
            case "XMLTYPE":
                localDataType = AltibaseO2AConstants.TYPE_FQ_XML;
                break;
            case "JSON":
            case "JSONB":
                localDataType = "JSON";
            ...
            case "GEOGRAPHY":
            case "SDO_GEOMETRY":
                localDataType = AltibaseO2AConstants.TYPE_FQ_GEOMETRY;
                break;
            case "NUMERIC":
                localDataType = AltibaseO2AConstants.TYPE_NUMBER;
    ...
    private SQLTokenPredicateSet makeDialectSkipTokenPredicates(JDBCDataSource dataSource) {
        ...
        // Altibase SQL references could be found from https://docs.oracle.com/en/database/oracle/oracle-database/
