 ...
 * Altibase sequence
 */
public class AltibaseSequence extends AltibaseSchemaObject implements DBSSequence, DBPScriptObject {
    ...
    public AltibaseSequence(AltibaseSchema schema, String name) {
    ...
    public AltibaseSequence(AltibaseSchema schema, ResultSet dbResult)
    {
        ...
        this.flagCycle = JDBCUtils.safeGetString(dbResult, "IS_CYCLE").equalsIgnoreCase(AltibaseConstants.YES)?true:false;
    }
