 ...
 * GenericProcedure
 */
public class AltibaseO2APackage extends AltibaseO2ASchemaObject
    implements AltibaseSourceObject, DBPScriptObjectExt, DBSObjectContainer, DBSPackage, DBPRefreshableObject, DBSProcedureContainer
{
    ...
    private static final Log log = Log.getLog(AltibaseO2APackage.class);
    ...
    public AltibaseO2APackage(AltibaseO2ASchema schema, String name)
    {
    ...
    {
        return AltibaseO2ASourceType.PACKAGE;
    }
    ...
    public String getExtendedDefinitionText(DBRProgressMonitor monitor) throws DBException
    {
        if (sourceDefinition == null && monitor != null) {
            sourceDefinition = AltibaseO2AUtils.getSource(monitor, this, true, true);
        }
    ...
    @Association
    public Collection<AltibaseO2AProcedurePackaged> getProceduresOnly(DBRProgressMonitor monitor) throws DBException {
    ...
    @Association
    public Collection<AltibaseO2AProcedurePackaged> getFunctionsOnly(DBRProgressMonitor monitor) throws DBException {
        return getProcedures(monitor)
            .stream()
    ...
    @Association
    public Collection<AltibaseO2AProcedurePackaged> getProcedures(DBRProgressMonitor monitor) throws DBException {
        return proceduresCache.getAllObjects(monitor, this);
    }

    @Override
    public AltibaseO2AProcedurePackaged getProcedure(DBRProgressMonitor monitor, String uniqueName) throws DBException {
    ...
    {
        return AltibaseO2AProcedurePackaged.class;
    }
    ...
    {
        this.valid = AltibaseO2AUtils.getObjectStatus(monitor, this, AltibaseO2AObjectType.PACKAGE) &&
        		AltibaseO2AUtils.getObjectStatus(monitor, this, AltibaseO2AObjectType.PACKAGE_BODY);
    }
    ...
    public DBEPersistAction[] getCompileActions(DBRProgressMonitor monitor)
    {
        ...
        try {
            if (!CommonUtils.isEmpty(getExtendedDefinitionText(monitor))) {
                actions.add(
                        new AltibaseO2AObjectPersistAction(
                            AltibaseO2AObjectType.PACKAGE_BODY,
    ...
    static class ProceduresCache extends JDBCObjectCache<AltibaseO2APackage, AltibaseO2AProcedurePackaged> {

        @NotNull
        @Override
        protected JDBCStatement prepareObjectsStatement(@NotNull JDBCSession session, @NotNull AltibaseO2APackage owner)
            throws SQLException
        {
        ...
        @Override
        protected AltibaseO2AProcedurePackaged fetchObject(@NotNull JDBCSession session, @NotNull AltibaseO2APackage owner, @NotNull JDBCResultSet dbResult)
            throws SQLException, DBException
        {
            return new AltibaseO2AProcedurePackaged(owner, dbResult);
        }

        @Override
        protected void invalidateObjects(DBRProgressMonitor monitor, AltibaseO2APackage owner, Iterator<AltibaseO2AProcedurePackaged> objectIter)
        {
            Map<String, AltibaseO2AProcedurePackaged> overloads = new HashMap<>();
            while (objectIter.hasNext()) {
                final AltibaseO2AProcedurePackaged proc = objectIter.next();
                ...
                final AltibaseO2AProcedurePackaged overload = overloads.get(proc.getName());
                if (overload == null) {
