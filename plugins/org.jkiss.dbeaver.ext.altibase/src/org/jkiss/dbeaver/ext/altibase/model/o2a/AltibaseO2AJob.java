...
public class AltibaseO2AJob extends AltibaseO2ASchemaObject implements AltibaseSourceObject {
    ...
    public AltibaseO2AJob(@NotNull AltibaseO2ASchema schema, @NotNull ResultSet resultSet) {
    ...
    public AltibaseO2ASourceType getSourceType() {
        return AltibaseO2ASourceType.JOB;
    }
