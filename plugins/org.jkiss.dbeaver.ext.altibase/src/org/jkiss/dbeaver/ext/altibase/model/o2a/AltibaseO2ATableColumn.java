 ...
 * AltibaseTableColumn
 */
public class AltibaseO2ATableColumn extends JDBCTableColumn<AltibaseO2ATableBase> implements
    DBSTableColumn, DBSTypedObjectEx, DBSTypedObjectExt3, DBPHiddenObject, DBPNamedObject2, DBSTypedObjectExt4<AltibaseO2ADataType>, DBPObjectWithLazyDescription
{
    private static final Log log = Log.getLog(AltibaseO2ATableColumn.class);

    private AltibaseO2ADataType type;
    private String comment;
    private boolean hidden;
    private Integer scale;

    public AltibaseO2ATableColumn(AltibaseO2ATableBase table)
    {
        super(table, false);
    }

    public AltibaseO2ATableColumn(
        ...
        throws DBException
    {
        ...
        this.type = AltibaseO2ADataType.resolveDataType(
            monitor,
            getDataSource(),
        ...
        this.hidden = JDBCUtils.safeGetBoolean(dbResult, "HIDDEN_COLUMN", AltibaseO2AConstants.YES);
    }
    ...
    @Override
    public void setDataType(AltibaseO2ADataType type)
    {
        this.type = type;
    ...
    public static class CommentLoadValidator implements IPropertyCacheValidator<AltibaseO2ATableColumn> {
        @Override
        public boolean isPropertyCached(AltibaseO2ATableColumn object, Object propertyId)
        {
    ...
    public static class ColumnDataTypeListProvider implements IPropertyValueListProvider<AltibaseO2ATableColumn> {
        ...
        @Override
        public Object[] getPossibleValues(AltibaseO2ATableColumn column)
        {
