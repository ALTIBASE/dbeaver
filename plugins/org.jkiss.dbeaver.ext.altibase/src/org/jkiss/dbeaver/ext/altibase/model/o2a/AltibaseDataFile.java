 ...
 */
public class AltibaseDataFile extends AltibaseObject<AltibaseTablespace> {
    ...
    private final AltibaseTablespace tablespace;
    private long id;
    ...
    protected AltibaseDataFile(AltibaseTablespace tablespace, ResultSet dbResult, boolean temporary)
    {
        super(
            tablespace,
    ...
    public AltibaseTablespace getTablespace()
    {
        return tablespace;
    }
