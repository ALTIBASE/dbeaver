 ...
 * AltibasePrivUser
 */
public class AltibaseO2APrivUser extends AltibaseO2APriv implements DBSObjectLazy<AltibaseO2ADataSource> {
    private Object user;
    private boolean defaultRole;

    public AltibaseO2APrivUser(AltibaseO2AGrantee user, ResultSet resultSet) {
    ...
    public Object getUser(DBRProgressMonitor monitor) throws DBException
    {
        ...
        return AltibaseO2AUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().userCache, this, null);
    }
