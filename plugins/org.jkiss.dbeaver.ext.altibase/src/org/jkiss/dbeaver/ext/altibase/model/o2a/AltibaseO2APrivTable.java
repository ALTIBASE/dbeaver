 ...
 * AltibasePrivTable
 */
public class AltibaseO2APrivTable extends AltibaseO2AObject<AltibaseO2ATableBase> implements DBAPrivilege {
    private String grantee;
    private String grantor;
    private boolean grantable;
    private boolean hierarchy;

    public AltibaseO2APrivTable(AltibaseO2ATableBase table, ResultSet resultSet) {
