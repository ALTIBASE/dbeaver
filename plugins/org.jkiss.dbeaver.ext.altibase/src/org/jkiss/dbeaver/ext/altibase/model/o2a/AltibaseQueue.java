 ...
 * Altibase sequence
 */
public class AltibaseQueue extends AltibaseSchemaObject {

    private static final Log log = Log.getLog(AltibaseQueue.class);
    ...
    public AltibaseQueue(AltibaseSchema schema, String name) {
        super(schema, name, false);
    }

    public AltibaseQueue(AltibaseSchema schema, ResultSet dbResult) {
    ...
    public AltibaseTableBase getQueueTable(DBRProgressMonitor monitor) throws DBException {
