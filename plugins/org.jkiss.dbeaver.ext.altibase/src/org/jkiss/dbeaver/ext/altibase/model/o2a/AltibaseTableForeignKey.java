 ...
 */
public class AltibaseTableForeignKey extends AltibaseTableConstraintBase implements DBSTableForeignKey
{
    private static final Log log = Log.getLog(AltibaseTableForeignKey.class);

    private AltibaseTableConstraint referencedKey;
    private DBSForeignKeyModifyRule deleteRule;

    public AltibaseTableForeignKey(
        @NotNull AltibaseTableBase oracleTable,
        @Nullable String name,
        @Nullable AltibaseObjectStatus status,
        @Nullable AltibaseTableConstraint referencedKey,
        ...
        throws DBException
    {
        ...
        AltibaseTableBase refTable = AltibaseTableBase.findTable(
            monitor,
            table.getDataSource(),
            refOwnerName,
            refTableName);
        if (refTable == null) {
            ...
            if (referencedKey == null) {
                ...
                referencedKey = new AltibaseTableConstraint(refTable, "refName", DBSEntityConstraintType.UNIQUE_KEY, null, AltibaseObjectStatus.ERROR);
            }
        }
    ...
    public AltibaseTableBase getReferencedTable()
    {
    ...
    public AltibaseTableConstraint getReferencedConstraint()
    {
        return referencedKey;
    }

    public void setReferencedConstraint(AltibaseTableConstraint referencedKey) {
        this.referencedKey = referencedKey;
    }
    ...
    @Override
    public AltibaseTableBase getAssociatedEntity()
    {
