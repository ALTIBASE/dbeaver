...
public class TableCache extends JDBCStructLookupCache<GenericStructContainer, GenericTableBase, GenericTableColumn> {
        ...
        throws SQLException, DBException
    {
        ...
        if (!CommonUtils.isEmpty(typeName)) {
            ...
            if (typeName.toUpperCase(Locale.ENGLISH).endsWith(AltibaseConstants.TYPE_MODIFIER_IDENTITY)) {
                autoIncrement = true;
                typeName = typeName.substring(0, typeName.length() - AltibaseConstants.TYPE_MODIFIER_IDENTITY.length());
            }
