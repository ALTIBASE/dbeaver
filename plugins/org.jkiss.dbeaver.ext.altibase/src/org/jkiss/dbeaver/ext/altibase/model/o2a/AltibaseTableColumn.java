 ...
 * AltibaseTableColumn
 */
public class AltibaseTableColumn extends JDBCTableColumn<AltibaseTableBase> implements
    DBSTableColumn, DBSTypedObjectEx, DBSTypedObjectExt3, DBPHiddenObject, DBPNamedObject2, DBSTypedObjectExt4<AltibaseDataType>, DBPObjectWithLazyDescription
{
    private static final Log log = Log.getLog(AltibaseTableColumn.class);

    private AltibaseDataType type;
    private String comment;
    private boolean hidden;
    private Integer scale;

    public AltibaseTableColumn(AltibaseTableBase table)
    {
        super(table, false);
    }
        ...
        throws DBException
    {
        ...
        this.type = AltibaseDataType.resolveDataType(
            monitor,
            getDataSource(),
        ...
        this.hidden = JDBCUtils.safeGetBoolean(dbResult, "HIDDEN_COLUMN", AltibaseConstants.YES);
    }
    ...
    public AltibaseDataType getDataType() {
        return type;
    }

    @Override
    public void setDataType(AltibaseDataType type)
    {
        this.type = type;
    ...
    public static class CommentLoadValidator implements IPropertyCacheValidator<AltibaseTableColumn> {
        @Override
        public boolean isPropertyCached(AltibaseTableColumn object, Object propertyId)
        {
    ...
    public static class ColumnDataTypeListProvider implements IPropertyValueListProvider<AltibaseTableColumn> {
        ...
        @Override
        public Object[] getPossibleValues(AltibaseTableColumn column)
        {
