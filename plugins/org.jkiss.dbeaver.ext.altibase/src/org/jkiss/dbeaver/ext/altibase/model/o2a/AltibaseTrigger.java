 ...
 * AltibaseTrigger
 */
public abstract class AltibaseTrigger<PARENT extends DBSObject> extends AltibaseObject<PARENT> implements DBSTrigger, DBPQualifiedObject, AltibaseSourceObject
{
    ...
    public AltibaseTrigger(PARENT parent, String name)
    {
        super(parent, name, false);
    }

    public AltibaseTrigger(
        PARENT parent,
        ResultSet dbResult)
    {
        ...
        this.status = CommonUtils.valueOf(AltibaseObjectStatus.class, JDBCUtils.safeGetStringTrimmed(dbResult, "STATUS"));
    ...
    {
        return AltibaseSourceType.TRIGGER;
    }
    ...
    public String getObjectDefinitionText(DBRProgressMonitor monitor, Map<String, Object> options) throws DBException
    {
        if (sourceDeclaration == null && monitor != null) {
            sourceDeclaration = AltibaseUtils.getSource(monitor, this, false, false);
        }
    ...
    {
        return status == AltibaseObjectStatus.ENABLED ? DBSObjectState.NORMAL : DBSObjectState.INVALID;
    }

    @Override
    public void refreshObjectState(@NotNull DBRProgressMonitor monitor) throws DBCException
    {
        this.status = (AltibaseUtils.getObjectStatus(monitor, this, AltibaseObjectType.TRIGGER) ? AltibaseObjectStatus.ENABLED : AltibaseObjectStatus.ERROR);
    }
