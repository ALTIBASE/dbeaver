 ...
 * AltibasePrivObject
 */
public class AltibasePrivObject extends AltibaseObject<AltibaseGrantee> implements DBAPrivilege {
    ...
    public AltibasePrivObject(AltibaseGrantee grantee, ResultSet resultSet) {
