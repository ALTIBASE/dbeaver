...
public class AltibaseJob extends AltibaseSchemaObject implements AltibaseSourceObject {
    ...
    public AltibaseJob(@NotNull AltibaseSchema schema, @NotNull ResultSet resultSet) {
