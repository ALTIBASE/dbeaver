 ...
 */
public class AltibaseO2ATriggerColumn extends AbstractTriggerColumn
{
    private static final Log log = Log.getLog(AltibaseO2ATriggerColumn.class);

    private AltibaseO2ATrigger trigger;
    private String name;
    private AltibaseO2ATableColumn tableColumn;
    private boolean columnList;

    public AltibaseO2ATriggerColumn(
        DBRProgressMonitor monitor,
        AltibaseO2ATrigger trigger,
    ...
    AltibaseO2ATriggerColumn(AltibaseO2ATrigger trigger, AltibaseO2ATriggerColumn source)
    {
        this.trigger = trigger;
    ...
    @Override
    public AltibaseO2ATrigger getTrigger()
    {
        return trigger;
    }
    ...
    public AltibaseO2ATableColumn getTableColumn()
    {
        return tableColumn;
    }
    ...
    @Override
    public AltibaseO2ATrigger getParentObject()
    {
        return trigger;
    }
