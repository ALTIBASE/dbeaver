 ...
 * GenericTable
 */
public class AltibaseProcedureParameter extends JDBCAttribute implements DBSProcedureParameter
{
    private String remarks;
    private AltibaseProcedure procedure;
    private DBSProcedureParameterKind parameterKind;

    public AltibaseProcedureParameter(
            AltibaseProcedure procedure,
            String columnName,
            String typeName,
            int valueType,
            int ordinalPosition,
    ...
    @Override
    public AltibaseProcedure getParentObject()
    {
        return procedure;
    }
