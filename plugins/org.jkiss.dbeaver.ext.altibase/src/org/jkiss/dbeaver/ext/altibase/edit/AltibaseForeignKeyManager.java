 ...
 */
public class AltibaseForeignKeyManager extends SQLForeignKeyManager<AltibaseTableForeignKey, AltibaseTableBase> {

    @Nullable
    @Override
    public DBSObjectCache<? extends DBSObject, AltibaseTableForeignKey> getObjectsCache(AltibaseTableForeignKey object)
    {
    ...
    @Override
    protected AltibaseTableForeignKey createDatabaseObject(DBRProgressMonitor monitor, DBECommandContext context, final Object container, Object from, Map<String, Object> options) {
        AltibaseTableBase tableBase = (AltibaseTableBase)container;
        AltibaseTableForeignKey foreignKey = tableBase.getDataSource().getMetaModel().createTableForeignKeyImpl(
            tableBase,
            null,
            null,
            null,
    ...
    @Override
    protected StringBuilder getNestedDeclaration(DBRProgressMonitor monitor, AltibaseTableBase owner, DBECommandAbstract<AltibaseTableForeignKey> command, Map<String, Object> options) {
    ...
    @Override
    protected void appendUpdateDeleteRule(AltibaseTableForeignKey foreignKey, StringBuilder decl) {
    ...
    @Override
    protected boolean isFKConstraintDuplicated(AltibaseTableBase owner) {
