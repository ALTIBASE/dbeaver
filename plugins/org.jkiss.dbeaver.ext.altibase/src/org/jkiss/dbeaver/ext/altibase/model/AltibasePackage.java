 ...
 * GenericPackage
 */
public class AltibasePackage extends AltibaseObjectContainer implements DBPQualifiedObject, AltibaseScriptObject, DBSPackage
{
    ...
    {
        return AltibaseProcedure.class;
    }
    ...
    public void hasProcedure(AltibaseProcedure procedure)
    {
        procedures.add(procedure);
    }
