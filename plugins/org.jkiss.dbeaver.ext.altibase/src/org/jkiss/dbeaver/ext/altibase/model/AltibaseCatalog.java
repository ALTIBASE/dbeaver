 ...
 * GenericCatalog
 */
public class AltibaseCatalog extends AltibaseObjectContainer implements DBSCatalog
{
    private final String catalogName;
    private List<AltibaseSchema> schemas;
    private boolean isInitialized = false;

    public AltibaseCatalog(@NotNull AltibaseDataSource dataSource, @NotNull String catalogName)
    {
        super(dataSource);
    ...
    @Override
    public AltibaseCatalog getObject()
    {
        return this;
    }

    public Collection<AltibaseSchema> getSchemaList(DBRProgressMonitor monitor)
        throws DBException
    {
    ...
    @Association
    public Collection<AltibaseSchema> getSchemas(DBRProgressMonitor monitor)
        throws DBException
    {
    ...
    public AltibaseSchema getSchema(DBRProgressMonitor monitor, String name)
        throws DBException
    {
