 ...
 * AltibaseUserProfile
 */
public class AltibaseO2AUserProfile extends AltibaseO2AGlobalObject
{
    private static final Log log = Log.getLog(AltibaseO2AUserProfile.class);

    private String name;

    public AltibaseO2AUserProfile(AltibaseO2ADataSource dataSource, ResultSet resultSet) {
     ...
     * ProfileResource
     */
    public static class ProfileResource extends AltibaseO2AObject<AltibaseO2AUserProfile>
    {
        ...
        public ProfileResource(AltibaseO2AUserProfile profile, ResultSet resultSet) {
