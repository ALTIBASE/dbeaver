 ...
 * AltibaseUser
 */
public class AltibaseUser extends AltibaseGrantee implements DBAUser, DBSObjectLazy<AltibaseDataSource>
{
    private static final Log log = Log.getLog(AltibaseUser.class);
    ...
    public AltibaseUser(AltibaseDataSource dataSource)
    {
        super(dataSource);
    }

    public AltibaseUser(AltibaseDataSource dataSource, ResultSet resultSet) {
        super(dataSource);
    ...
    {
        return AltibaseUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().profileCache, this, "profile");
    }
    ...
    public static class ProfileReferenceValidator implements IPropertyCacheValidator<AltibaseUser> {
        @Override
        public boolean isPropertyCached(AltibaseUser object, Object propertyId)
        {
            return
                object.getLazyReference(propertyId) instanceof AltibaseUserProfile ||
