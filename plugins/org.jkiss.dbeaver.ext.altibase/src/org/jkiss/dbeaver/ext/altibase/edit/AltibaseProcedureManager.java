...
import org.jkiss.dbeaver.ext.altibase.model.AltibaseObjectContainer;
import org.jkiss.dbeaver.ext.altibase.model.AltibaseProcedure;
 ...
 */
public class AltibaseProcedureManager extends SQLObjectEditor<AltibaseProcedure, AltibaseStructContainer> {
    ...
    @Nullable
    @Override
    public DBSObjectCache<? extends DBSObject, AltibaseProcedure> getObjectsCache(AltibaseProcedure object)
    {
        AltibaseStructContainer container = object.getContainer();
        return new ListCache<>(((AltibaseObjectContainer) container).getProcedureCache());
    }

    @Override
    protected AltibaseProcedure createDatabaseObject(
    ...
    {
        AltibaseProcedure object = command.getObject();
    ...
    @Override
    public boolean canDeleteObject(AltibaseProcedure object) {
        return true;
    }
