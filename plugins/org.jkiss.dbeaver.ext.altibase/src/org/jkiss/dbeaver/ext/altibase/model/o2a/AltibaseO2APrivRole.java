 ...
 * AltibasePrivRole
 */
public class AltibaseO2APrivRole extends AltibaseO2APriv implements DBSObjectLazy<AltibaseO2ADataSource> {
    private Object role;
    private boolean defaultRole;

    public AltibaseO2APrivRole(AltibaseO2AGrantee user, ResultSet resultSet) {
    ...
    public Object getRole(DBRProgressMonitor monitor) throws DBException
    {
        ...
        return AltibaseO2AUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().roleCache, this, null);
    }
