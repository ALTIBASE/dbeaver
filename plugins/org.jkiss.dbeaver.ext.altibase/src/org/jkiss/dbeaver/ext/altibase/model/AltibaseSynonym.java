 ...
 */
public abstract class AltibaseSynonym implements DBSAlias, DBSObject, DBPQualifiedObject, DBPNamedObject2
{
    private AltibaseStructContainer container;
    private String name;
    private String description;

    protected AltibaseSynonym(AltibaseStructContainer container, String name, String description) {
