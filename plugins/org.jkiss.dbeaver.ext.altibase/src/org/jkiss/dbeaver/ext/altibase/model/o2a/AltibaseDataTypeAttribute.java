 ...
 */
public class AltibaseDataTypeAttribute
    extends AltibaseDataTypeMember
    implements DBSEntityAttribute, DBSTypedObjectEx {

    private final AltibaseDataType attrType;
    private final Integer length;
    private final Integer precision;
    private final Integer scale;

    public AltibaseDataTypeAttribute(DBRProgressMonitor monitor, AltibaseDataType dataType, ResultSet dbResult) {
        ...
        this.attrType = AltibaseDataType.resolveDataType(
            monitor,
            getDataSource(),
