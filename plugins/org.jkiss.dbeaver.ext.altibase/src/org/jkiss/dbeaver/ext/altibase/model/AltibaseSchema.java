 ...
 * GenericSchema
 */
public class AltibaseSchema extends AltibaseObjectContainer implements DBSSchema, DBPSystemObject, DBPVirtualObject
{
    @Nullable
    private final AltibaseCatalog catalog;
    @NotNull
    private final String schemaName;
    private boolean virtualSchema;

    public AltibaseSchema(@NotNull AltibaseDataSource dataSource, @Nullable AltibaseCatalog catalog, @NotNull String schemaName)
    {
        super(dataSource);
    ...
    @Override
    public AltibaseSchema getObject()
    {
        return this;
    }
