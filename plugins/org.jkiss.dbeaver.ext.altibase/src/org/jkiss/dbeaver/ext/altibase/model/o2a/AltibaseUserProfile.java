 ...
 * AltibaseUserProfile
 */
public class AltibaseUserProfile extends AltibaseGlobalObject
{
    private static final Log log = Log.getLog(AltibaseUserProfile.class);

    private String name;

    public AltibaseUserProfile(AltibaseDataSource dataSource, ResultSet resultSet) {
     ...
     * ProfileResource
     */
    public static class ProfileResource extends AltibaseObject<AltibaseUserProfile>
    {
        ...
        public ProfileResource(AltibaseUserProfile profile, ResultSet resultSet) {
