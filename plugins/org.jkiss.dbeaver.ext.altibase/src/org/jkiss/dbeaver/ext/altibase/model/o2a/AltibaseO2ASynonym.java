 ...
 * Altibase synonym
 */
public class AltibaseO2ASynonym extends AltibaseO2ASchemaObject implements DBSAlias {
    ...
    public AltibaseO2ASynonym(AltibaseO2ASchema schema, ResultSet dbResult)
    {
    ...
    {
        return AltibaseO2AObjectType.getByType(objectTypeName);
    }
    ...
    {
        final AltibaseO2ASchema schema = getDataSource().schemaCache.getCachedObject(objectOwner);
    ...
    public Object getObject(DBRProgressMonitor monitor) throws DBException
    {
        ...
        return AltibaseO2AObjectType.resolveObject(
            monitor,
            getDataSource(),
            dbLink,
            objectTypeName,
    ...
    public String getFullyQualifiedName(DBPEvaluationContext context) {
        if (AltibaseO2AConstants.USER_PUBLIC.equals(getSchema().getName())) {
