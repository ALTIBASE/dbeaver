 ...
 * Altibase data type
 */
public class AltibaseO2ADataType extends AltibaseO2AObject<DBSObject>
    implements DBSDataType, DBSEntity, DBPQualifiedObject, AltibaseSourceObject, DBPScriptObjectExt {

    private static final Log log = Log.getLog(AltibaseO2ADataType.class);
    ...
    */
    ...
    private AltibaseO2ADataType componentType;

    public AltibaseO2ADataType(DBSObject owner, String typeName, boolean persisted)
    {
        super(owner, typeName, persisted);
        //this.methodCache = new MethodCache();
        if (owner instanceof AltibaseO2ADataSource) {
            flagPredefined = true;
            findTypeDesc(typeName);
        }
    }

    public AltibaseO2ADataType(DBSObject owner, ResultSet dbResult)
    {
    ...
    {
        return parent instanceof AltibaseO2ASchema ? (AltibaseO2ASchema)parent : null;
    }

    @Override
    public AltibaseO2ASourceType getSourceType()
    {
        return AltibaseO2ASourceType.TYPE;
    }
    ...
    public String getExtendedDefinitionText(DBRProgressMonitor monitor) throws DBException
    {
        if (sourceDefinition == null && monitor != null) {
            sourceDefinition = AltibaseO2AUtils.getSource(monitor, this, true, false);
        }
    ...
    {
        return parent instanceof AltibaseO2ASchema ?
            parent :
            parent instanceof AltibaseO2ADataSource ? ((AltibaseO2ADataSource) parent).getContainer() : null;
    }
    ...
    public AltibaseO2ADataType getSuperType(DBRProgressMonitor monitor)
    {
    	return null;
    }
    ...
    @Override
    @Association
    public List<AltibaseO2ADataTypeAttribute> getAttributes(@NotNull DBRProgressMonitor monitor)
        throws DBException
    {
        return null;
    }
    ...
    @Override
    public AltibaseO2ADataTypeAttribute getAttribute(@NotNull DBRProgressMonitor monitor, @NotNull String attributeName) throws DBException
    {
        return null;
    }
    ...
    */
    ...
    public AltibaseO2ADataType getComponentType(@NotNull DBRProgressMonitor monitor)
        throws DBException
    {
    ...
    public static AltibaseO2ADataType resolveDataType(DBRProgressMonitor monitor, AltibaseO2ADataSource dataSource, String typeOwner, String typeName)
    {
        typeName = normalizeTypeName(typeName);
        AltibaseO2ASchema typeSchema = null;
        AltibaseO2ADataType type = null;
        if (typeOwner != null) {
            try {
            ...
            type = (AltibaseO2ADataType)dataSource.getLocalDataType(typeName);
        }
        if (type == null) {
            log.debug("Data type '" + typeName + "' not found - declare new one");
            type = new AltibaseO2ADataType(typeSchema == null ? dataSource : typeSchema, typeName, true);
