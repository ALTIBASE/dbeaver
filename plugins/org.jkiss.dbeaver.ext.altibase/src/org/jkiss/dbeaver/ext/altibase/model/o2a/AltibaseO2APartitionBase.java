...
/**
 * Altibase abstract partition
 */
public abstract class AltibaseO2APartitionBase<PARENT extends DBSObject> extends AltibaseO2AObject<PARENT> implements DBSObjectLazy
{
    ...
    public static class PartitionInfoBase {
        ...
        public PartitionInfoBase(DBRProgressMonitor monitor, AltibaseO2ADataSource dataSource, ResultSet dbResult) throws DBException
        {
    ...
    protected AltibaseO2APartitionBase(PARENT parent, boolean subpartition, ResultSet dbResult)
    {
        super(
            parent,
            subpartition ?
