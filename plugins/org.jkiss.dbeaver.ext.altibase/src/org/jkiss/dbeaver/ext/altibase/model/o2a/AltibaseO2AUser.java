 ...
 * AltibaseUser
 */
public class AltibaseO2AUser extends AltibaseO2AGrantee implements DBAUser, DBSObjectLazy<AltibaseO2ADataSource>
{
    private static final Log log = Log.getLog(AltibaseO2AUser.class);
    ...
    public AltibaseO2AUser(AltibaseO2ADataSource dataSource)
    {
        super(dataSource);
    }

    public AltibaseO2AUser(AltibaseO2ADataSource dataSource, ResultSet resultSet) {
        super(dataSource);
    ...
    {
        return AltibaseO2ATablespace.resolveTablespaceReference(monitor, this, "defaultTablespace");
    }
    ...
    {
        return AltibaseO2ATablespace.resolveTablespaceReference(monitor, this, "tempTablespace");
    }
    ...
    {
        return AltibaseO2AUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().profileCache, this, "profile");
    }
    ...
    public static class ProfileReferenceValidator implements IPropertyCacheValidator<AltibaseO2AUser> {
        @Override
        public boolean isPropertyCached(AltibaseO2AUser object, Object propertyId)
        {
            return
                object.getLazyReference(propertyId) instanceof AltibaseO2AUserProfile ||
