 ...
 * AltibasePrivTable
 */
public class AltibasePrivTable extends AltibaseObject<AltibaseTableBase> implements DBAPrivilege {
    private String grantee;
    private String grantor;
    private boolean grantable;
    private boolean hierarchy;

    public AltibasePrivTable(AltibaseTableBase table, ResultSet resultSet) {
