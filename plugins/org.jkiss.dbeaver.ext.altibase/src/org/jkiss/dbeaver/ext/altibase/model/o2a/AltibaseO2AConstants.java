...
public class AltibaseO2AConstants {
	public static final String SCHEMA_SYS = "SYS";
	public static final String USER_PUBLIC = "PUBLIC";
	
    public static final String EDIT_ALTIBASE_DEPENDENCIES_DEPENDENCY_NAME			= "Dependencies";
    public static final String EDIT_ALTIBASE_DEPENDENCIES_DEPENDENCY_DESCRIPTION	= "The objects this object depends on.";
    public static final String EDIT_ALTIBASE_DEPENDENCIES_DEPENDENT_NAME			= "Dependent";
    public static final String EDIT_ALTIBASE_DEPENDENCIES_DEPENDENT_DESCRIPTION		= "The objects that depend on this object.";
    ...
    /************************
     * TODO: Need refactoring below
     ************************/
    public static final String CMD_COMPILE = "org.jkiss.dbeaver.ext.altibase.code.compile"; //$NON-NLS-1$
    ...
    public static final String PROP_AUTH_LOGON_AS = "altibase.logon-as";
    ...
    public static final String PROP_SEARCH_METADATA_IN_SYNONYMS = "altibase.meta-search-in-synonyms"; //$NON-NLS-1$
    ...
    public static final String PREF_EXPLAIN_TABLE_NAME = "altibase.explain.table";
    public static final String PREF_SUPPORT_ROWID = "altibase.support.rowid";
    public static final String PREF_DBMS_OUTPUT = "altibase.dbms.output";
    public static final String PREF_DBMS_READ_ALL_SYNONYMS = "altibase.read.all.synonyms";
    public static final String PREF_DISABLE_SCRIPT_ESCAPE_PROCESSING = "altibase.disable.script.escape";

    public static final String NLS_DEFAULT_VALUE = "Default";
    public static final String PREF_KEY_DDL_FORMAT = "altibase.ddl.format";
    ...
    public static final String VAR_ORACLE_NET_TNS_ADMIN = "altibase.net.tns_admin";
    ...
    public static final String XMLTYPE_CLASS_NAME = "altibase.xdb.XMLType";
    public static final String BFILE_CLASS_NAME = "altibase.sql.BFILE";
    public static final String TIMESTAMP_CLASS_NAME     = "altibase.sql.TIMESTAMP";
    public static final String TIMESTAMPTZ_CLASS_NAME   = "altibase.sql.TIMESTAMPTZ";
    public static final String TIMESTAMPLTZ_CLASS_NAME  = "altibase.sql.TIMESTAMPLTZ";
