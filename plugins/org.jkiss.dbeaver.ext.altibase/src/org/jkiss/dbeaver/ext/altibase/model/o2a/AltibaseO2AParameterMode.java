...
*/
public enum AltibaseO2AParameterMode {
    ...
    AltibaseO2AParameterMode(DBSProcedureParameterKind parameterKind)
    {
        this.parameterKind = parameterKind;
    }

    public static AltibaseO2AParameterMode getMode(String modeName)
    {
        if (CommonUtils.isEmpty(modeName)) {
            ...
            return AltibaseO2AParameterMode.OUT;
        } else {
            return AltibaseO2AParameterMode.INOUT;
        }
    }
