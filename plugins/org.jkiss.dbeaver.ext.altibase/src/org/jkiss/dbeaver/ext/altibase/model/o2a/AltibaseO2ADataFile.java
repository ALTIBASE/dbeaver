...
/**
 * Altibase tablespace file
 */
public class AltibaseO2ADataFile extends AltibaseO2AObject<AltibaseO2ATablespace> {
    ...
    private final AltibaseO2ATablespace tablespace;
    private long id;
    ...
    protected AltibaseO2ADataFile(AltibaseO2ATablespace tablespace, ResultSet dbResult, boolean temporary)
    {
        super(
            tablespace,
    ...
    public AltibaseO2ATablespace getTablespace()
    {
        return tablespace;
    }
