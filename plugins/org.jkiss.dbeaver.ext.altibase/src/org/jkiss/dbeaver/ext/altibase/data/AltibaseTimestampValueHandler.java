 ...
 * Object type support
 */
public class AltibaseTimestampValueHandler extends JDBCDateTimeValueHandler {

    private final AltibaseDataSource dataSource;

    public AltibaseTimestampValueHandler(AltibaseDataSource dataSource, DBDFormatSettings formatSettings)
    {
