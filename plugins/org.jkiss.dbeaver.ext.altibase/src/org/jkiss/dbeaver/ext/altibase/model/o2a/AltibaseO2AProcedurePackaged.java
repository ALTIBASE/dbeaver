 ...
 * GenericProcedure
 */
public class AltibaseO2AProcedurePackaged extends AltibaseO2AProcedureBase<AltibaseO2APackage> implements DBPUniqueObject
{
    private Integer overload;

    public AltibaseO2AProcedurePackaged(
        AltibaseO2APackage ownerPackage,
        ResultSet dbResult)
    {
        super(ownerPackage,
