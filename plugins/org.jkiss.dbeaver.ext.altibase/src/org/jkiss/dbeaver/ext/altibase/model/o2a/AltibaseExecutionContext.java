 ...
 */
public class AltibaseExecutionContext extends JDBCExecutionContext implements DBCExecutionContextDefaults<DBSCatalog, AltibaseSchema> {
    private static final Log log = Log.getLog(AltibaseExecutionContext.class);

    private String activeSchemaName;

    AltibaseExecutionContext(@NotNull JDBCRemoteInstance instance, String purpose) {
    ...
    @NotNull
    @Override
    public AltibaseExecutionContext getContextDefaults() {
        return this;
    }
    ...
    @Override
    public void setDefaultCatalog(DBRProgressMonitor monitor, DBSCatalog catalog, AltibaseSchema schema) throws DBCException {
        throw new DBCFeatureNotSupportedException();
    }

    @Override
    public void setDefaultSchema(DBRProgressMonitor monitor, AltibaseSchema schema) throws DBCException {
        final AltibaseSchema oldSelectedEntity = getDefaultSchema();
    ...
    public boolean refreshDefaults(DBRProgressMonitor monitor, boolean useBootstrapSettings) throws DBException {
        ...
        try (JDBCSession session = openSession(monitor, DBCExecutionPurpose.META, "Query active schema")) {
            ...
            // Get active schema
            this.activeSchemaName = AltibaseUtils.getCurrentSchema(session);
    ...
    void setCurrentSchema(DBRProgressMonitor monitor, AltibaseSchema object) throws DBCException {
        if (object == null) {
    ...
    private void setCurrentSchema(DBRProgressMonitor monitor, String activeSchemaName) throws DBCException {
        ...
        try (JDBCSession session = openSession(monitor, DBCExecutionPurpose.UTIL, TASK_TITLE_SET_SCHEMA)) {
            AltibaseUtils.setCurrentSchema(session, activeSchemaName);
