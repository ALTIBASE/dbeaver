 ...
 */
public class AltibaseTableColumn extends JDBCTableColumn<AltibaseTableBase> implements DBSTableColumn, DBPNamedObject2, JDBCColumnKeyType, DBPOrderedObject
{
    private int radix;
    ...
    {
        final Collection<AltibaseUniqueKey> uniqueKeysCache = getTable().getContainer().getConstraintKeysCache().getCachedObjects(getTable());
        if (!CommonUtils.isEmpty(uniqueKeysCache)) {
            for (AltibaseUniqueKey key : uniqueKeysCache) {
